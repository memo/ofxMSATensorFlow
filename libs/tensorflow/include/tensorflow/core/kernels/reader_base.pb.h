...
class ReaderBaseState : public ::google::protobuf::Message {
 public:
  ReaderBaseState();
 ...
 private:
  ...
  friend void  protobuf_AddDesc_tensorflow_2fcore_2fkernels_2freader_5fbase_2eproto();
  friend void protobuf_AssignDesc_tensorflow_2fcore_2fkernels_2freader_5fbase_2eproto();
  friend void protobuf_ShutdownFile_tensorflow_2fcore_2fkernels_2freader_5fbase_2eproto();

  void InitAsDefaultInstance();
  static ReaderBaseState* default_instance_;
};
// ===================================================================
...
inline void ReaderBaseState::set_current_work(const void* value, size_t size) {

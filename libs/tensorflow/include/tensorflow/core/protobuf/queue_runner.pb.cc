...
void protobuf_AddDesc_tensorflow_2fcore_2fprotobuf_2fqueue_5frunner_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "ueRunnerProtosP\001b\006proto3", 224);
...
QueueRunnerDef* QueueRunnerDef::New(::google::protobuf::Arena* arena) const {
  QueueRunnerDef* n = new QueueRunnerDef;
  if (arena != NULL) {
    arena->Own(n);
  }
  return n;
...
void QueueRunnerDef::MergeFrom(const QueueRunnerDef& from) {
  ...
  if (from.close_op_name().size() > 0) {
    ...
    close_op_name_.AssignWithDefault(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), from.close_op_name_);
  }
  if (from.cancel_op_name().size() > 0) {

    cancel_op_name_.AssignWithDefault(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), from.cancel_op_name_);
  }
}
...
void QueueRunnerDef::clear_queue_name() {
 ...
 void QueueRunnerDef::set_queue_name(const char* value, size_t size) {
...
void QueueRunnerDef::clear_close_op_name() {
 ...
 void QueueRunnerDef::set_close_op_name(const char* value, size_t size) {
...
void QueueRunnerDef::clear_cancel_op_name() {
 ...
 void QueueRunnerDef::set_cancel_op_name(const char* value, size_t size) {

...
http://github.com/memo/ofxMSATensorFlo
...
//Status PrintTopLabels(const std::vector<Tensor>& outputs, const vector<string> &labels) {
...
//        LOG(INFO) << labels.at(label_index) << " (" << label_index << "): " << score;
//    }
